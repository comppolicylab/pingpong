...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["option_id"], ["lecture_video_question_options.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["question_id"], ["lecture_video_questions.id"], ondelete="CASCADE"
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "lecture_video_question_correct_option_idx",
        table_name="lecture_video_question_correct_options",
    )
    op.drop_table("lecture_video_question_correct_options")
