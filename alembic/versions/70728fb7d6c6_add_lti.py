...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "lti_status",
            sa.Enum("LINKED", "ERROR", "PENDING", name="ltistatus"),
            nullable=False,
        ),
        ...
        sa.Column(
            "lti_platform", sa.Enum("CANVAS", name="lmsplatform"), nullable=False
        ),
    ...
    op.create_index(
        ...
        "lti_registrations_institutions",
        ["lti_registration_id", "institution_id"],
        unique=True,
    )
    op.add_column(
        "users_classes", sa.Column("lti_class_id", sa.Integer(), nullable=True)
    )
    op.create_foreign_key(
        "users_classes_lti_class_id_fkey",
        "users_classes",
        "lti_classes",
        ["lti_class_id"],
        ["id"],
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(
        "users_classes_lti_class_id_fkey", "users_classes", type_="foreignkey"
    )
    op.drop_column("users_classes", "lti_class_id")
    op.drop_index(
        "lti_registration_institution_idx", table_name="lti_registrations_institutions"
    )
    ...
    sa.Enum("LINKED", "ERROR", "PENDING", name="ltistatus").drop(
        op.get_bind(), checkfirst=True
    )
    # ### end Alembic commands ###
