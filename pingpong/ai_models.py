...
KNOWN_MODELS: dict[str, schemas.AssistantModelDict] = {
    ...
    "gpt-5.6-luna": {
        ...
        "supports_web_search": True,
        "supports_mcp_server": True,
        "description": "GPT-5.6 model optimized for latency and cost.",
    },
    "chat-latest": {
        "name": "GPT Instant",
        "sort_order": 0.08,
    ...
    "gpt-5.5": {
        ...
        "supports_web_search": True,
        "supports_mcp_server": True,
        "description": "Previous frontier model for complex work. Control how long the model spends thinking in Advanced Options. Set reasoning effort to none for the non-thinking version of this model.",
    },
    "gpt-5.4": {
        "name": "GPT-5.4",
        "sort_order": 0.1,
        ...
        "supports_web_search": True,
        "supports_mcp_server": True,
        "description": "Previous flagship model for broad general-purpose work. Control how long the model spends thinking in Advanced Options. Set reasoning effort to none for the non-thinking version of this model.",
    },
    "gpt-5.2": {
        "name": "GPT-5.2",
        "sort_order": 0.11,
    ...
    "gpt-realtime-2.1": {
        ...
        "supports_web_search": False,
        "supports_mcp_server": False,
        "description": "Most capable realtime voice model, with improved alphanumeric recognition, silence and noise handling, and interruption behavior.",
    },
    "gpt-realtime-2.1-mini": {
        ...
        "supports_web_search": False,
        "supports_mcp_server": False,
        "description": "Faster reasoning model for realtime voice interactions, with improved alphanumeric recognition.",
    },
    "gpt-realtime-2": {
        "name": "GPT Realtime 2",
        "default_prompt_id": "voice_mode_v1",
        ...
        "supports_web_search": False,
        "supports_mcp_server": False,
        "description": "Previous capable realtime voice model, with strong reasoning, instruction following, and tool-use reliability.",
    },
    "gpt-realtime-1.5": {
