...
KNOWN_MODELS: dict[str, schemas.AssistantModelDict] = {
    ...
    "o3-mini": {
        ...
        "supports_verbosity": False,
        "supports_web_search": False,
        "description": "Faster reasoning model particularly good at coding, math, and science.",
    },
    #
    # -----------------   gpt-4o Family   -----------------
    #
    ...
    "gpt-4o-mini-realtime-preview": {
        ...
        "supports_verbosity": False,
        "supports_web_search": False,
        "description": "Smaller model capable of responding to audio inputs in real-time.",
    },
    #
    # ----------------- Pinned Models -----------------
    #
