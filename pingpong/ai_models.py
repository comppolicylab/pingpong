...
KNOWN_MODELS: dict[str, schemas.AssistantModelDict] = {
    ...
    "gpt-5.2": {
        ...
        "description": "Best model for complex tasks that require broad world knowledge, with advances in instruction following. Control how long the model spends thinking in Advanced Options.",
    },
    "gpt-5.1": {
        "name": "GPT-5.1",
        "sort_order": 0.2,
