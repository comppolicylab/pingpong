...
async def copy_assistant(
    ...
    *,
    ...
    new_assistant = models.Assistant(
        ...
        elevenlabs_stability=assistant.elevenlabs_stability,
        elevenlabs_similarity_boost=assistant.elevenlabs_similarity_boost,
        ...
        prevent_user_thread_deletion=assistant.prevent_user_thread_deletion,
