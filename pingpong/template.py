...
<html>
   ...
   <body style="margin:0; padding:0;" class="body">
      ...
      <!-- BEGIN MOBILE BODY --> 
      <div><div class="mobile mobile-bg" style="width: 0; max-height: 0; overflow: hidden; display: none;"">
         <div class="m-gutter">
            <h1 class="m-title" style="margin-top: 50px; margin-bottom: 30px; font-weight: 600; font-size: 40px; line-height:42px;letter-spacing:-1px;border-bottom:0; font-family: STIX Two Text, serif; font-weight:700;"> You&#8217;re invited to join $class on PingPong.</h1>
         </div>
      </div>
      ...
      <!-- BEGIN DESKTOP BODY --> 
      <table role="presentation" class="desktop-bg" width="736" class="desktop" cellspacing="0" cellpadding="0" border="0" align="center">
         <tbody>
            <tr>
               <td>
