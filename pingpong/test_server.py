...
<html>
   ...
   <body style="margin:0; padding:0;" class="body">
      ...
      <div class="mobile mobile-bg" style="width: 0; max-height: 0; overflow: hidden; display: none;">
         <div class="m-gutter">
            <p>You're only one click away from logging in to PingPong. Just click on the button below to sign-in to your account, no password required. It's secure, super easy, and basically like magic.</p>
            ...
            <p><b>Note:</b> This login link was intended for <span style="white-space: nowrap;"><a href="user_123@domain.test" style="color:#0070c9;">user_123@domain.test</a></span>. If you weren&#8217;t expecting this login link, there&#8217;s nothing to worry about — you can safely ignore it.</p>
            <br>
         </div>
      </div>
      <div class="mobile mobile-bg" style="width: 0; max-height: 0; overflow: hidden; display: none;">
