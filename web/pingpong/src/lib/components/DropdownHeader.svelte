<script lang="ts">
  ...
  // The color classes to apply to the header. Include a from and to class for the gradient.
...
<div class="sticky top-0 z-{order * 10} bg-gradient-to-r {colorClasses} drop-shadow-md">
  {#if topHeader}
