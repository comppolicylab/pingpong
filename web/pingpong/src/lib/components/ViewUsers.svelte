...
<div class="relative">
	{#if loading}
		<div
			class="absolute top-0 left-0 z-10 flex h-full w-full flex-col items-center justify-center gap-4 bg-white/90 dark:bg-black/90"
		>
						...
						<TableBodyCell {tdClass}>
								...
								<div class="flex flex-row justify-between">
									<div class="flex flex-col">
										...
										{#if roleInfo.other.length > 0}
											<div
												class="mt-2 text-xs font-light text-pretty whitespace-normal text-gray-500"
											>
							...
							{:else}
								...
								{#if !roleInfo.primary && roleInfo.other.length === 0}
									<div class="mt-2 text-xs font-light text-pretty whitespace-normal text-gray-500">
