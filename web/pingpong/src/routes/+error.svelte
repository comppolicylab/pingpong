...
>
	<div class="relative w-full max-w-208">
		<div
			class="pointer-events-none absolute -top-20 -left-15 h-75 w-75 rounded-full opacity-[0.5] filter-[blur(120px)] [background:radial-gradient(circle,#6d28d9_0%,transparent_70%)]"
		></div>
		<div
			class="pointer-events-none absolute -right-12.5 -bottom-17.5 h-70 w-70 rounded-full opacity-[0.5] filter-[blur(120px)] [background:radial-gradient(circle,#2563eb_0%,transparent_70%)]"
		></div>
		<div
			class="pointer-events-none absolute -bottom-22.5 left-[30%] h-70 w-70 rounded-full opacity-[0.3] filter-[blur(120px)] [background:radial-gradient(circle,#db2777_0%,transparent_70%)]"
		></div>
		<section
		...
		>
			<div class="mx-auto w-full max-w-312 px-6 py-10 md:px-12 md:pt-[3.2rem] md:pb-12">
				<div class="grid grid-cols-1 gap-8">
					<div>
						<h1
							class="m-0 max-w-[24ch] text-[clamp(1.35rem,2.5vw,2.1rem)] leading-[1.15] font-semibold tracking-[-0.02em] text-slate-900"
						>
							{title}
						</h1>
						<p class="mt-4 mb-0 max-w-[62ch] text-base leading-[1.7] text-slate-700">
							{description}
						</p>
					</div>
				</div>
				...
				<div class="mt-7 border-t border-slate-900/10 pt-4">
					...
					{#if showTechnicalDetails}
						...
						>
							<p
								class="mt-3 mb-0 rounded-xl border border-slate-900/10 bg-slate-50/90 px-[0.85rem] py-3 font-mono text-xs leading-normal wrap-anywhere text-slate-700"
							>
