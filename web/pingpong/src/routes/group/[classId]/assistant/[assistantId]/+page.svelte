    ...
    <div class="leading-6 w-full">
      <Accordion flush>
        <AccordionItem class="py-2">
          ...
          <Helper class="pb-1"
            >Select the model temperature to use for this assistant, between 0 and 2. Temperature is
            a parameter that controls the "creativity" or randomness of the text generated by the
            model. Higher values like 0.8 will result in more diverse and creative output, while
            lower values like 0.2 will make the output more deterministic and focused. You can
            update your temperature selection at any time.</Helper
          >
          <Range
            id="temperature"
            name="temperature"
