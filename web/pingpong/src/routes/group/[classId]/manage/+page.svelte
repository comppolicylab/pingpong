          ...
          {#if !hasApiKey}
            <form on:submit={submitUpdateApiKey}>
              ...
              <div class="grid gap-4 w-full xl:w-2/3 md:grid-cols-2 mb-5">
                <Radio name="provider" value="openai" bind:group={apiProvider} custom class="hidden-radio">
                  <div
                ...
                <Radio name="provider" value="azure" bind:group={apiProvider} custom class="hidden-radio">
                  <div
