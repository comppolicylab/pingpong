...
export const load = async ({ fetch, params }: Parameters<PageLoad>[0]) => {
	...
	const [classDataResponse, grants, canvasInstances, ltiClasses, assistantsResponse] =
		await Promise.all([
	...
	return {
		...
		exportAssistants: assistantsResponse.error ? [] : assistantsResponse.data.assistants,
